  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <img src="assets/img/logo-icon.png" alt="" class="logo-icon">
         <h1 class="logo-text">Tirta Nirwana</h1> 

        {{-- <h1 class="sitename">Tirta Nirwana</h1> --}}
      </a>

      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="#hero" class="active">Home</a></li>
          <li class="dropdown"><a href="#about">Program Les<span></span><i class="bi bi-chevron-down toggle-dropdown"></a></i>
            <ul>
      ...
      <a class="cta-btn" href="#contact">Daftar Sekarang</a>
      ...
      <div class="container">
        ...
        {{-- <div class="row gy-4">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <h3 class="text-align: center;">About</h3>
            <img src="assets/img/teacher/abo-1.jpg" class="img-fluid rounded-4 mb-4" alt="">
            <p style="text-align: center;">Tirta Nirwana adalah lembaga pelatihan renang yang berdiri sejak tahun 2022 dengan komitmen untuk melatih dan membimbing anak-anak serta remaja 
              dalam menguasai teknik renang yang baik dan benar. Sejak awal berdiri, Tirta Nirwana telah mengalami berbagai tantangan, 
              tetapi kepercayaan wali
              murid yang semakin kuat mendorong pertumbuhan jumlah siswa dari 20 siswa menjadi 60 siswa saat ini.
            </p>
          </div> --}}
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center" data-aos="fade-up" data-aos-delay="100">
              <h3>About</h3>
              <img src="assets/img/teacher/abo-1.jpg" class="img-fluid rounded-4 mb-4" alt="">
              <p>Tirta Nirwana adalah lembaga pelatihan renang yang berdiri sejak tahun 2022 dengan komitmen untuk melatih dan membimbing anak-anak serta remaja 
                dalam menguasai teknik renang yang baik dan benar. Sejak awal berdiri, Tirta Nirwana telah mengalami berbagai tantangan, 
                tetapi kepercayaan wali
                murid yang semakin kuat mendorong pertumbuhan jumlah siswa dari 20 siswa menjadi 60 siswa saat ini.
              </p>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            ...
            <div class="row justify-content-center">
              <div class="position-relative mt-4">
                ...
                <a href="https://www.youtube.com/live/zQl3NRxZED0?si=hbCTQZMHCxusuU_A" class="glightbox pulsating-play-btn"></a>
              </div>
            {{-- </div>
            <div class="position-relative mt-4">
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-12">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <h3>Address</h3>
                  <p>Jl. Raya Wonorejo Permai, Wonorejo, Kec. Rungkut, Surabaya, Jawa Timur 60296</p>
                </div>
              </div><!-- End Info Item -->
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="footer-contact pt-3">
            <p>Jl. Raya Wonorejo Permai, Wonorejo, </p>
            <p>kec. Rungkut, Surabaya, Jawa Timur 60296</p>
            <p class="mt-3"><strong>Phone:</strong> <span>+ 62858-5253-2681</span></p>
            <p><strong>Email:</strong> <span>tirtanirwana@gmail.com</span></p>
          </div>
